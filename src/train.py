...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_eval', type=str, default='/home/ubuntu/Wav2ToBI/data/output_json/test_tone.json', help='Path to the evaluation (test) dataset (a JSON file)')
    parser.add_argument('--num_epochs', type=int, default=10, help='Number of epochs')
    parser.add_argument('--batch_size', type=int, default=1, help='Batch size')
    parser.add_argument('--file_output', type=str, default='/home/ubuntu/Wav2ToBI/data/output_json/test_output_tone.txt', help='Path for the output file (output.txt)')
    parser.add_argument('--model_save_dir', type=str, default='/home/ubuntu/Wav2ToBI/checkpoints/test_checkpoint', help='Directory for saving the training log and the finetuned model')
